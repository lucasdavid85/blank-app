...
(() => {
 ...
 document.getElementById('fullscreen').addEventListener('click',async()=>{
  ...
  catch{document.getElementById('focus-hint').hidden=false;document.getElementById('focus-hint').textContent='Le plein écran est indisponible ici. Vous pouvez utiliser F11.';}
